...
from core.parsing_schemas import ResumeSchema, Contact
...
class CVAgent:
    ...
    def _parse_deterministic(self, resume_text: str) -> Dict[str, Any]:
        ...
        for i, line in enumerate(lines):
            ...
            if '(' in line and '-' in line and ('now' in line_lower or '2024' in line or '2025' in line):
        ...
        skill_keywords = [
            'Python', 'Scala', 'Java', 'TypeScript', 'JavaScript',
            'LangChain', 'LangGraph', 'PyTorch', 'TensorFlow', 'Keras',
            'FastAPI', 'Flask', 'Django', 'Docker', 'Kubernetes',
            'AWS', 'GCP', 'Azure', 'Spark', 'Airflow',
            'PostgreSQL', 'MongoDB', 'Redis', 'RAG', 'LLM'
        ]
