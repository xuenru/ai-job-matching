...
Examples:
  ...
  python cli.py clear-cache
    ...
    parser.add_argument(
        '--resume',
        default='resume.md',
        help='Path to resume markdown file (default: resume.md)'
    )
    
    parser.add_argument(
        '--jobs-dir',
        default='JDs',
        help='Directory containing job markdown files (default: JDs)'
    )
    ...
    try:
        if args.command == 'parse-resume':
            ...
            print(f"  Cached at: cache/resume_parsed.json")
            ...
            print(f"  Cached at: cache/jobs_parsed.json")
